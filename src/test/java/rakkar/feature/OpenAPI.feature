...
Feature: Open API
  ...
  Scenario: Open API - Get Vault Details
    * call read('this:OpenAPI_ReadSchema.feature@Read_schema_vault')
    * def vaultList = call read('this:OpenAPI.feature@GetVaultList')
  ...
  @RAKCON-29947 @Get_whitelist_third_party
  Scenario: Open API - Get whitelist
    * header x-api-key = key
    * header account-id = accountId
  ...
  @RAKCON-29948 @Get_whitelist_my_organization
  Scenario: Open API - Get whitelist
    * header x-api-key = key
    * header account-id = accountId
  ...
  Scenario: Open API - Get transaction by destination address
    * def transactionList = call read('this:OpenAPI.feature@Transaction_by_destinationId')
  ...
  Scenario: Open API - Get transaction detail
    * def transactionList = call read('this:OpenAPI.feature@Transaction_by_type')
    * def transactionId = transactionList.response.transactions[0].transaction_id
    * header x-api-key = key
    * header account-id = accountId
  ...
  Scenario: Open API - Transaction listing common
    * call read('this:OpenAPI_ReadSchema.feature@Read_schema_transaction')
    * header x-api-key = key
    * header account-id = accountId
